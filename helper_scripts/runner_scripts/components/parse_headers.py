...
class ParseHeaders(Component):
    ...
    def __init__(self, value_dict):
        ...
        if 'c2xml_bin' in value_dict:
            c2xml_path = value_dict['c2xml_bin']  # i don't know the function
        ...
        self.hdr_file_list = hdr_file_list          # output
...
gcc_bins = ['aarch64-linux-android-gcc', 'arm-eabi-gcc']             # need to be modified


def _handle_compile_command(comp_str, dst_includes):           # need to be modified 
